...
static constexpr uint8_t PI_FORWARD[ 256 ] = {
...
static constexpr uint8_t PI_REVERSE[ 256 ] = { 
    ...
    95,  175, 43,  134, 167, 177, 178, 91,  70,  211, 159, 253, 212, 15,  156, 47,
    ...
    35,  248, 243, 62,  61,  189, 138, 136, 221, 205, 11,  19,  152, 2,   147, 128,
    144, 208, 36,  52,  203, 237, 244, 206, 153, 16,  68,  64,  146, 58,  1,   38,
    18,  26,  72,  104, 245, 129, 139, 199, 214, 32,  10,  8,   0,   76,  215, 116
};

static constexpr uint8_t TAU_FORWARD[ 64 ] = {
...
static constexpr std::array<uint8_t, 64> C[ 12 ] = {
...
static constexpr uint64_t A_transposed[] = {
    ...
    0x025da344601ea1b8, 0x012ed1a2308fd05c, 0x8017685198c7e8ae, 0x408bb4284c63f457,
    0x2218f9d046afdb13, 0x13515facc3c94cb1, 0x0b758c12817a87e0, 0x05ba4689c03d4370,
    0xa1f0c986411102cc, 0xd0f864c3a0080166, 0xe87cb2e1508480b3, 0xf4bed9f0a8c24059,
    0xdb2f257e95702260, 0x4c67db398ba913fc, 0x87c3241a04450b32, 0x43e1920d82220599,
    0xe0802541868b1232, 0x704012a0c3458999, 0xb8208950e12244cc, 0x5c1044a8f011a266,
    0x4e0887957e834381, 0xc704668b394ab3f2, 0x830296041a2e4bcb, 0xc1014b820d172565,
    0x7dd80c6d98218914, 0x3e6c06b64c90440a, 0x9f36835b26c8a285, 0x4f1bc1ad93e45142,
    0xda55ecbbd1d3a135, 0x10727ab0f048598e, 0xf56131b560852553, 0xfab018da30421229,
    0x82b12139880c7f01, 0x4158909cc4063f80, 0xa02cc8cee2831f40, 0x5016e46771c10f20,
    0x2abad30ab0ecf811, 0x17ec48bc507a0309, 0x09c785e72031fe05, 0x046342731018ff02,
    0x91e9e113a54e2b57, 0x4874f009522715ab, 0xa43af804a9138a55, 0xd21d7c825409c5aa,
    0x78e75f528f4a4982, 0xad9aceba62eb0f16, 0x47a4864e943bac5c, 0x23d2c3274a9d56ae,
    0x06016a5c89d498b1, 0x8380b5ae446a4c58, 0xc140da57a2b5262c, 0xe0206dab51da9316,
    0x7611dc09a1b9d1ba, 0x3d0984585908f0ec, 0x1805a870255060c7, 0x0c02d4b812a83063
};
...
class GOST_34_11_2012_256__HASH_BLOCK
{
public:
...
private:
    static void S_Transform( uint8_t* data ) noexcept
    {
    ...
    static void P_Transform( uint8_t* data ) noexcept
    {
    ...
    void G_Transform( const uint8_t* N, const uint8_t* h, const uint8_t* m, uint8_t* out )
    {
        ...
        E_transform( buf, m, buf );
        X_Transform( buf, h, buf );
        X_Transform( buf, m, buf );
...
public:
    ...
    {
        result.resize( GOST_34_11_2012_256__HASH_BLOCK::HASH_SIZE );
        hash.Final();
